...
wget -q -O /usr/bin/backup "https://raw.githubusercontent.com/dragon-andy/VVIP/ipuk/backup/backup.sh" && chmod +x /usr/bin/backup
wget -q -O /usr/bin/restore "https://raw.githubusercontent.com/dragon-andy/VVIP/ipuk/backup/restore.sh" && chmod +x /usr/bin/restore
wget -q -O /usr/bin/cleaner "https://raw.githubusercontent.com/dragon-andy/VVIP/ipuk/backup/logcleaner.sh" && chmod +x /usr/bin/cleaner
