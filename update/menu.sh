...
Exp=$(curl -sS https://raw.githubusercontent.com/dragon-andy/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "  ${BLUE}• ${GREEN}Slowdns Domain      ${NC}= $( cat /etc/xray/nsdomain )"
